...
> [!NOTE]
> The current stable release is **v1.4.1**, including OpenYoink Island, its modular top surface, and the optional Now Playing module. See the [guide](https://muqy1818.github.io/OpenYoink/en/guide/) for the complete walkthrough.
